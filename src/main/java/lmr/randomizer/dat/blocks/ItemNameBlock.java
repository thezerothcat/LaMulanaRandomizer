...
public class ItemNameBlock extends Block {
    ...
    public static final int Coin = 106;
    public static final int ShurikenAmmo = 107;
    public static final int RollingShurikenAmmo = 108;
    public static final int EarthSpearAmmo = 109;
    public static final int FlareGunAmmo = 110;
    public static final int BombAmmo = 111;
    public static final int ChakramAmmo = 112;
    public static final int CaltropsAmmo = 113;
    public static final int PistolAmmo = 114;
    public static final int SoulStone = 115;

    public ItemNameBlock(int blockNumber) {
        super(blockNumber);
    }

    public void setName(int index, TextEntry newItemNameData) {
        getBlockContents().set(index, newItemNameData);
    }
}
