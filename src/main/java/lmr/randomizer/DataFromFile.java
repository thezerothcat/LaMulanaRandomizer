...
public final class DataFromFile {
    ...
    public static List<Integer> STARTING_LOCATIONS = Arrays.asList(0, 2, 3, 5, 7, -7, 8, 10, 11, 13, 16, 21);
    ...
    public static Map<String, NodeWithRequirements> getMapOfNodeNameToRequirementsObject() {
        if(mapOfNodeNameToRequirementsObject == null) {
            ...
            if(Settings.isEasterMode()) {
                FileUtils.populateRequirements(mapOfNodeNameToRequirementsObject, "requirement/egg_reqs.txt", true);
            }
    ...
    public static List<String> getWinRequirements() {
        if(winRequirements == null) {
            if(Settings.isHalloweenMode()) {
                ...
                winRequirements = FileUtils.getList("requirement/win/egg_reqs.txt");
            }
            else {
