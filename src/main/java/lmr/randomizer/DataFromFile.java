...
public final class DataFromFile {
    ...
    public static List<Integer> RANDOM_ITEM_GRAPHICS = Arrays.asList(1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15,
            18, 19, 20, 21, 24, 25, 26, 27, 28, 29, 32, 33, 38, 39, 41, 42, 43, 44,
            45, 47, 48, 49, 51, 52, 53, 54, 55, 56, 5, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69,
            73, 76, 91, 96, 97, 98, 99, 100, 102, 103, 104);
