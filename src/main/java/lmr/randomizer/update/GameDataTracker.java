...
import lmr.randomizer.dat.BlockColorsData;
...
import lmr.randomizer.dat.BlockSingleData;
...
//        }
    ...
    public static void writeShopInventory(ShopBlock shopBlock, String shopItem1, String shopItem2, String shopItem3, List<Block> blocks,
        ...
        if (!recursive && Settings.isAutomaticMantras()) {
            if (ItemConstants.KEY_SWORD.equals(shopItem1) || ItemConstants.KEY_SWORD.equals(shopItem2) || ItemConstants.KEY_SWORD.equals(shopItem3)) {
...
//        }
    ...
    public static void updateSubweaponPot(String weapon) {
        if (ItemConstants.SHURIKEN.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 3);
        } else if (ItemConstants.ROLLING_SHURIKEN.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 4);
        } else if (ItemConstants.EARTH_SPEAR.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 5);
        } else if (ItemConstants.FLARE_GUN.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 6);
        } else if (ItemConstants.BOMB.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 7);
        } else if (ItemConstants.CHAKRAM.equals(weapon)) {
            subweaponPot.getArgs().set(0, (short) 8);
        } else if (ItemConstants.CALTROPS.equals(weapon)) {
