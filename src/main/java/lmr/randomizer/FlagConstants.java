...
public final class FlagConstants {
    ...
    public static final int TWIN_UNSOLVABLE_PUZZLE = 0x1e4; // Value 0 > 1 when solving the block pushing puzzle in Twin Labyrinths on the screen with the lamp recharge station/Lamp of Time Shop
    ...
    public static final int SCREEN_FLAG_2B = 0x02b; // Used in randomizer, for fake item and/or trap screen flag for floating items (spawns bats)
    public static final int SCREEN_FLAG_2C = 0x02c;
    public static final int SCREEN_FLAG_2D = 0x02d;
    public static final int SCREEN_FLAG_2E = 0x02e; // Used in randomizer, for fake item and/or trap screen flag for chests (spawns bats); also doubles as screen flag for one of the crushers on Chain Whip puzzle; also used in Halloween 2019 on Mr. Slushfund's screen
    ...
    public static final int CUSTOM_WF_SPAULDER = 0xaca; // Triggers Spaulder to spawn.
